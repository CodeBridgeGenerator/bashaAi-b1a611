...
const SingleConversationsPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            ...
            .get(urlParams.singleConversationsId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleConversationsId]);
  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>conversations/{urlParams.singleConversationsId}</p> */}
            </div>
    ...
    <div className="col-12 mt-2">
      ...
      <CommentsSection
        recordId={urlParams.singleConversationsId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleConversationsPage);
