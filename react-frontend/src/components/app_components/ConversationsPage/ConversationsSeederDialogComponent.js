...
import seederData from "./conversations.seeder.json";
...
const ConversationsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ConversationsSeederDialogComponent);
