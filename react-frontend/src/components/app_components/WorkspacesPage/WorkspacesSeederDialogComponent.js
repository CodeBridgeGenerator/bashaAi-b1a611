...
import seederData from "./workspaces.seeder.json";
...
const WorkspacesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(WorkspacesSeederDialogComponent);
