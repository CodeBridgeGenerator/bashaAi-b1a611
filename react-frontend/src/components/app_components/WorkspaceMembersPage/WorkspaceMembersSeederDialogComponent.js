...
import seederData from "./workspaceMembers.seeder.json";
...
const WorkspaceMembersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(WorkspaceMembersSeederDialogComponent);
