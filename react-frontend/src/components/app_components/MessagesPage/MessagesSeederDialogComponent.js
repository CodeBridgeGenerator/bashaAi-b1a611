...
import seederData from "./messages.seeder.json";
...
const MessagesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MessagesSeederDialogComponent);
