...
import seederData from "./chatEmbeddings.seeder.json";
...
const ChatEmbeddingsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ChatEmbeddingsSeederDialogComponent);
