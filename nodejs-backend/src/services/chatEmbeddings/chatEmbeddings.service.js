const { ChatEmbeddings } = require("./chatEmbeddings.class");
const createModel = require("../../models/chatEmbeddings.model");
const hooks = require("./chatEmbeddings.hooks");
...
module.exports = function (app) {
  ...
  app.use("/chatEmbeddings", new ChatEmbeddings(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("chatEmbeddings");

  // Get the schema of the collections 
  app.get("/chatEmbeddingsSchema", function (request, response) {
