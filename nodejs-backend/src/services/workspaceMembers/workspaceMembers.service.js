const { WorkspaceMembers } = require("./workspaceMembers.class");
const createModel = require("../../models/workspaceMembers.model");
const hooks = require("./workspaceMembers.hooks");
...
module.exports = function (app) {
  ...
  app.use("/workspaceMembers", new WorkspaceMembers(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("workspaceMembers");

  // Get the schema of the collections 
  app.get("/workspaceMembersSchema", function (request, response) {
